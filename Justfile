...
doctor:
    @echo "Running diagnostics for universal-language-server-plugin..."
...
heal:
    @echo "Attempting auto-repair for universal-language-server-plugin..."
...
tour:
    @echo "=== universal-language-server-plugin Tour ==="
    @echo ""
...
help-me:
    @echo "=== universal-language-server-plugin Help ==="
