...
[arabic]
. *Install Server*: Build and install the Rust server
. *Install Client*: Install editor-specific client for your editor
. *Configure*: Set server path in client configuration
. *Test*: Open a Markdown/HTML/JSON file and test conversion commands

==== Future Migrations

When upgrading to future versions, consult version-specific migration
guides.
...
* https://github.com/universal-connector/universal-language-connector[Repository]
* https://github.com/universal-connector/universal-language-connector/issues[Issue
Tracker]
* https://universal-connector.org/docs[Documentation]
* https://github.com/universal-connector/universal-language-connector/blob/main/CHANGELOG.md[Changelog]

'''''

*Changelog Format*: https://keepachangelog.com/[Keep a Changelog]
*Versioning*: https://semver.org/[Semantic Versioning]
