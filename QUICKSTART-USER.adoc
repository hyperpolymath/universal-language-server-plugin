...
// Replace universal-language-server-plugin, Universal Language Server Plugin — See README.adoc for details., just run, Universal Language Server Plugin started successfully. with actuals
= universal-language-server-plugin — Quick Start for Users
:toc:
:toclevels: 2

== What is universal-language-server-plugin?

Universal Language Server Plugin — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./universal-language-server-plugin-portable
----
...
[source]
----
Universal Language Server Plugin started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/universal-language-server-plugin/wiki
