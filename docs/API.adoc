...
*Status Codes:* - `+200 OK+` - Conversion successful -
...
*Status Codes:* - `+200 OK+` - Document found - `+404 Not Found+` -
Document not found
...
*Status Codes:* - `+204 No Content+` - Document deleted -
...
Currently, the server does not implement authentication. For production
use:
...
Future versions will maintain backward compatibility within major
versions following Semantic Versioning (SemVer).
