...
:experimental:
:url-github: https://github.com/hyperpolymath/universal-language-server-plugin
:url-gitlab: https://gitlab.com/hyperpolymath/universal-language-server-plugin
:url-bitbucket: https://bitbucket.org/hyperpolymath/universal-language-server-plugin
:url-codeberg: https://codeberg.org/hyperpolymath/universal-language-server-plugin

Universal Language Server Protocol plugin
...
universal-language-server-plugin is part of the link:https://rhodium.sh[Rhodium Standard] (RSR) ecosystem.
